...
})({"di3r3":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
    ...
    return function(Module1) {
        ...
        function whenDependentTypesAreResolved(myTypes, dependentTypes, getTypeConverters) {
            ...
            dependentTypes.forEach(function(dt, i) {
                if (registeredTypes.hasOwnProperty(dt)) typeConverters1[i] = registeredTypes[dt];
                else {
                    ...
                    awaitingDependencies[dt].push(function() {
                        ...
                        ++registered;
                        if (registered === unregisteredTypes.length) onComplete(typeConverters1);
                    });
                }
            });
            if (0 === unregisteredTypes.length) onComplete(typeConverters1);
        }
        function __embind_finalize_value_array(rawTupleType) {
            ...
            var elementTypes1 = elements.map(function(elt) {
            ...
            whenDependentTypesAreResolved([
                rawTupleType
            ], elementTypes1, function(elementTypes) {
        ...
        function exposePublicSymbol(name, value, numArguments) {
            if (Module1.hasOwnProperty(name)) {
                if (undefined === numArguments || undefined !== Module1[name].overloadTable && undefined !== Module1[name].overloadTable[numArguments]) throwBindingError("Cannot register public name '" + name + "' twice");
                ensureOverloadTable(Module1, name, name);
                if (Module1.hasOwnProperty(numArguments)) throwBindingError("Cannot register multiple overloads of a function with the same number of arguments (" + numArguments + ")!");
                Module1[name].overloadTable[numArguments] = value;
            } else {
                Module1[name] = value;
                if (undefined !== numArguments) Module1[name].numArguments = numArguments;
            }
        }
        ...
        function replacePublicSymbol(name, value, numArguments) {
            if (!Module1.hasOwnProperty(name)) throwInternalError("Replacing nonexistant public symbol");
            if (undefined !== Module1[name].overloadTable && undefined !== numArguments) Module1[name].overloadTable[numArguments] = value;
            else {
                Module1[name] = value;
        ...
        var ___getTypeName = Module1["___getTypeName"] = function() {
            return (___getTypeName = Module1["___getTypeName"] = Module1["asm"]["F"]).apply(null, arguments);
        };
        var ___embind_register_native_and_builtin_types = Module1["___embind_register_native_and_builtin_types"] = function() {
            return (___embind_register_native_and_builtin_types = Module1["___embind_register_native_and_builtin_types"] = Module1["asm"]["G"]).apply(null, arguments);
        };
        var _malloc = Module1["_malloc"] = function() {
            return (_malloc = Module1["_malloc"] = Module1["asm"]["H"]).apply(null, arguments);
        };
        ...
        var stackAlloc = Module1["stackAlloc"] = function() {
            return (stackAlloc = Module1["stackAlloc"] = Module1["asm"]["K"]).apply(null, arguments);
        };
        var _free = Module1["_free"] = function() {
            return (_free = Module1["_free"] = Module1["asm"]["L"]).apply(null, arguments);
        };
        var dynCall_jiji = Module1["dynCall_jiji"] = function() {
            return (dynCall_jiji = Module1["dynCall_jiji"] = Module1["asm"]["M"]).apply(null, arguments);
        };
        var dynCall_iiiiij = Module1["dynCall_iiiiij"] = function() {
            return (dynCall_iiiiij = Module1["dynCall_iiiiij"] = Module1["asm"]["N"]).apply(null, arguments);
        };
        var dynCall_iiiiijj = Module1["dynCall_iiiiijj"] = function() {
            return (dynCall_iiiiijj = Module1["dynCall_iiiiijj"] = Module1["asm"]["O"]).apply(null, arguments);
        };
        var dynCall_iiiiiijj = Module1["dynCall_iiiiiijj"] = function() {
            return (dynCall_iiiiiijj = Module1["dynCall_iiiiiijj"] = Module1["asm"]["P"]).apply(null, arguments);
        };
        var dynCall_viijii = Module1["dynCall_viijii"] = function() {
            return (dynCall_viijii = Module1["dynCall_viijii"] = Module1["asm"]["Q"]).apply(null, arguments);
        };
        Module1["ccall"] = ccall;
        var calledRun;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["di3r3"], null, "parcelRequire656e")
